...
@Service
@Slf4j
public class ApprovedStatusProcessor2 extends AbstractTxnStatusProcessor {

	public ApprovedStatusProcessor2(
	...
	public TransactionDto processStatusInternal(TransactionDto dto) {
		log.info("Processing status in ApprovedStatusProcessor, dto={}", dto);
