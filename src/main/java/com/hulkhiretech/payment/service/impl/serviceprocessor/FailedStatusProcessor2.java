...
@Service
@Slf4j
public class FailedStatusProcessor2 extends AbstractTxnStatusProcessor {

	public FailedStatusProcessor2(
	...
	public TransactionDto processStatusInternal(TransactionDto dto) {
		log.info("Processing status in FailedStatusProcessor, dto={}", dto);
