...
@Service
@Slf4j
public class InitiatedStatusProcessor2 extends AbstractTxnStatusProcessor {

	public InitiatedStatusProcessor2(
	...
	public TransactionDto processStatusInternal(TransactionDto dto) {
		log.info("Processing status in InitiatedStatusProcessor, dto={}", dto);
