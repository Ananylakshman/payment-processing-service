...
@Service
@Slf4j
public class SuccessStatusProcessor2 extends AbstractTxnStatusProcessor {

	public SuccessStatusProcessor2(
	...
	public TransactionDto processStatusInternal(TransactionDto dto) {
		log.info("Processing status in SuccessStatusProcessor, dto={}", dto);
